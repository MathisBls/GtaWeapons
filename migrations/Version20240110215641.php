 ...
 */
final class Version20240110215641 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE armes (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, nom VARCHAR(255) NOT NULL, magazine_capacity VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, rate_of_fire INT NOT NULL, INDEX IDX_32CF26E0BCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE degats (id INT AUTO_INCREMENT NOT NULL, armes_id INT NOT NULL, partieducorps_id INT NOT NULL, degats INT NOT NULL, INDEX IDX_1ECEE60B7A649A7 (armes_id), INDEX IDX_1ECEE60B333C8DCF (partieducorps_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `rank` (id INT AUTO_INCREMENT NOT NULL, img VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
